using CharlieBackend.Api.Services;
using CharlieBackend.Application.DTOs.Settings;
using CharlieBackend.Application.Interfaces;
using CharlieBackend.Application.Interfaces.Shared;
using CharlieBackend.Infrastructure.DbContexts;
using CharlieBackend.Infrastructure.Identity.Models;
using CharlieBackend.Infrastructure.Identity.Services;
using CharlieBackend.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\CharlieBackend.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
