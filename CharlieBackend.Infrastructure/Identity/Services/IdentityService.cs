using CharlieBackend.Application.DTOs.Identity;
using CharlieBackend.Application.DTOs.Mail;
using CharlieBackend.Application.DTOs.Settings;
using CharlieBackend.Application.Enums;
using CharlieBackend.Application.Exceptions;
...
namespace CharlieBackend.Infrastructure.Identity.Services
{
